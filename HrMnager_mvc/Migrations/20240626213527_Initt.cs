        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HrManagers_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Employees_HrManagers_HrManagerId",
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DepartmentId", "Email", "EmployeeId", "FullName", "Gender", "HrManagerId", "PasswordHash", "PhoneNumber", "RoleId", "Salary", "Salt" },
                values: new object[] { 1, null, "admin@gmail.com", null, "Admin", 1, null, "$2a$11$BItFS/jAEawWeZw12B5RdO7IKlw08mQltRwDeAu/guDfe.Z284/a.", "09154682311", 1, 0m, "" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HrManagers_DepartmentId",
                table: "HrManagers",
                column: "DepartmentId",
                unique: true);
